...
<script type="text/javascript">
	...
	function deleteRelation(activityId){
		$.ajax({
	...
	function showActivityNotRelationList(){
		$.ajax({
			url:"workbench/clue/getActivityNotRelationList.do",
			data:{
				"clueId":"${clue.id}",
				"name":$.trim($("#name").val())
			},
...
<%--						</tr>--%>
			...
			<div>
				<a href="javascript:void(0);" id="showRelationBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>

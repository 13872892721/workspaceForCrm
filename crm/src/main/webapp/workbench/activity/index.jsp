...
<link rel="stylesheet" type="text/css" href="jquery/bs_pagination/jquery.bs_pagination.min.css" charset="UTF-8">
...
<script type="text/javascript" src="jquery/bs_pagination/en.js" charset="UTF-8"></script>
	...
	$(function(){
		...
		$("#addBtn").click(function (){
			 ...
			 */
			$.ajax({
				url:"workbench/activity/users.do",
				type:"get",
				dataType:"json",
	...
	function pageList(pageNo,pageSize){
		...
		$.ajax({
			...
			success:function (data){
				/*
				 data
				 我们需要的:市场活动信息列表
				 [{市场活动13,{23,{3}] List<Activity> aList
				一会分页插件需要的:查询出来的总记录数
				{"total":100} int total
				{"total":100,"dataList":[{市场活动13},{23},{33}]}
				...
				var totalPages = data.total%parseInt(pageSize)==0?data.total/parseInt(pageSize):data.total/parseInt(pageSize)+1
		...
		语法:
			$(需要绑定元素的【有效】的外层元素).on(绑定事件的方式,需要绑定的元素的jquery对象,回调函数)
		*/
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" id="activityAddForm" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <label for="create-cost" class="col-sm-2 control-cost">成本</label>
                            <div class="col-sm-10" style="width: 300px;">
		...
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" id="activityUpdateFrom" role="form">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
					...
					点击创建按钮，观察两个属性和属性值
						...
						表示要打开哪个模态窗口，通过#id的形式找到该窗

						现在我们是以属性和属性值的方式写在了button元素中，
						用来打开模态窗口但是这样做是有问题的:
							问题在于没有办法对按钮的功能进行扩充

						所以未来的实际项目开发，对于触发模态窗口的操作，
						一定不要写死在元素当中，应该由我们自己写js代码来操作

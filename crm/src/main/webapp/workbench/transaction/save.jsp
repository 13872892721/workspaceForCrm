...
<script type="text/javascript">
	...
	$(function (){
		...
		$("#addActivityModalBtn").click(function (){
		...
		$("#bundBtn1").click(function (){
			...
			$("#create-activitySrc").val($("#"+$xz).html())
			$("#activityId").val($xz)
		...
		$("#bundBtn2").click(function (){
			var $xz = $("input[name=contacts]:checked").val()
			$("#create-contactsName").val($("#"+$xz).html())
			$("#contactsId").val($xz)
...
<%--							</tr>--%>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" id="bundBtn2">关联</button>
				</div>
			</div>
		</div>
	</div>
	...
	<form id="saveForm" action="workbench/transaction/save.do" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-accountName" name="company" placeholder="支持自动补全，输入客户不存在则新建">
			</div>
		...
		<div class="form-group">
			...
			<label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="addActivityModalBtn"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
